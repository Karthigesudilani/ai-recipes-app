  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="text-gray-400 mb-6">
              Transforming leftover ingredients into delicious meals with AI-powered recipe generation. 
              Join thousands of users who are already saving money and reducing food waste.
            </p>
          ...
          >
            ...
            >
              <Link 
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-orange-500 hover:bg-orange-600 text-white rounded-lg font-medium transition-colors w-fit"
              >
        ...
        >
          <p>&copy; 2024 Smart Recipe Finder. All rights reserved. Made with ❤️ for food lovers everywhere.</p>
        </motion.div>
      </div>
    </motion.footer>
  );
